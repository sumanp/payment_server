defmodule PaymentServerWeb.Resolvers.User do
  ...
  def send_money(
    ...
    to_wallet = Accounts.find_wallet_by_currency(%{user_id: to_user_id, currency: currency})
    from_wallet = Accounts.find_wallet_by_currency(%{user_id: from_user_id, currency: currency})
